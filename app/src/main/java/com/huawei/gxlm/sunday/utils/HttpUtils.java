package com.huawei.gxlm.sunday.utils;
...
public class HttpUtils {
    public static void getData(String url, Handler handler) {
    ...
    public static String doPostwithCookie(String url, String param, Context context) {
        PrintWriter out = null;
        BufferedReader in = null;
        String result = "";
        try {
     ...
     * @throws Exception
     */
    public static void doPostAsynWithCookie(final String urlStr, final String params, final Context context,
                                            final CallBack callBack) throws Exception {
        new Thread() {
            public void run() {
                try {
                    String result = doPostwithCookie(urlStr, params, context);
                    if (callBack != null) {
                        callBack.onRequestComplete(result);
                    }
                } catch (Exception e) {
